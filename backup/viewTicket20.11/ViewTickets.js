...
const ViewTickets = () => {
    ...
    const updateTimers = () => {
        setTimers(prevTimers => {
            ...
            tickets.forEach(ticket => {
                ...
                const remainingTime = calculateRemainingTime(ticket.dateEmission, slaDurations[ticket.priorite]);
    ...
    useEffect(() => {
        const interval = setInterval(updateTimers, 1000); // Met à jour les timers chaque seconde
